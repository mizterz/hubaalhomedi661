...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	?>
	<div id="login">
		<div style="padding: 15px; text-align:center; background: -webkit-linear-gradient(-0deg,#03a9f3 4%,#11b989 75%); background: -o-linear-gradient(-0deg,#03a9f3 4%,#11b989 75%); background: linear-gradient(90deg,#03a9f3 4%,#11b989 75%);border-radius: 5px;"><img src="<?php bloginfo('template_url'); ?>/images/main-logo.png" alt="<?php echo get_bloginfo('name');?>" style="width:100%;"/></div>
	<?php
	/**
