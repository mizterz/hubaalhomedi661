...
<!--[if gt IE 11]><!--> <html class="no-js" lang="en-US"> <!--<![endif]-->
    ...
    <!--[if IE]><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><![endif]-->
		...
		#main_area{background: #f9f9f9; margin:0 auto;padding: 40px 25px; min-height: 0;position: relative;left: 0; right: 0; top: 0; bottom: 0; width: 100%;font-size: 18px; font-weight: 400; line-height: 35px; color: #000;}
		...
		main {float: none; width: 100%; margin: 0 auto; padding: 0; height: auto; position: relative; left: 0; right: 0; top: 0; bottom: 0; min-height: 300px; font-size: 18px; font-weight: 400; line-height: 35px; color: #000;}
